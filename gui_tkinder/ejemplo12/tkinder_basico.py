...
# creando un boton
boton: Button = Button(raiz, text="Boton", command=lambda: entrada_texto.insert(1.0, entrada.get()))
...
radio_button: Radiobutton = Radiobutton(raiz, text="Opcion", variable=opcion, value=1, command=seleccionar)
radio_button.pack()
radio_button_dos: Radiobutton = Radiobutton(raiz, text="Opcion 2", variable=opcion, value=2, command=seleccionar)
radio_button_dos.pack()
radio_button_tres: Radiobutton = Radiobutton(raiz, text="Opcion 3", variable=opcion, value=3, command=seleccionar)
...
check_button: Checkbutton = Checkbutton(raiz, text="Verificacion", variable=check_uno, onvalue=1, offvalue=0, command=verificar)
check_button.pack()


# creando y mostrando un popup
boton_dos: Button = Button(raiz, text="Pulsa para visualizar", command=lambda: messagebox.showinfo("Titulo", "Mensaje"))
...
def abrir_fichero() -> None:
    ruta_fichero: str = filedialog.askopenfilename(initialdir="/home/juan/Descargas/", title="Selecciona un fichero", filetypes=(("Ficheros de texto", "*.txt"), ("Todos los ficheros", "*.*")))
    print(f"La ruta del fichero es: {ruta_fichero}")

boton_cuatro: Button = Button(raiz, text="Pulsa para abrir", command=abrir_fichero)
