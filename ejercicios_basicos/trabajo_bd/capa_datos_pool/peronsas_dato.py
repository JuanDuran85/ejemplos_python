...
if __name__ == "__main__":
    ...
    # insertando persona
    persona1 = Persona(nombre="Amie", apellido="Kohler",email="Jayda_Boehm22@gmail.com")
    insertando = PersonaDAO.insertar(persona1)
    log.debug(insertando)

    # actualiando persona
    persona1 = Persona(id_persona=11,nombre="Isabell", apellido="Murphy",email="Bradley.Streich88@yahoo.com")
