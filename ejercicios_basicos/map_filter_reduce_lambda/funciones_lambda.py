...
# -----------------------------------------------------------------------------------------
# you can use a lambda function in a dict comprehension to simplify things
# -----------------------------------------------------------------------------------------
...
print(f"{function_dict_one['sum'](4,6)}")
print(f"{function_dict_one['subtract'](4,6)}")
print(f"{function_dict_one['multiply'](4,6)}")
print(f"{function_dict_one['divide'](4,6)}")
