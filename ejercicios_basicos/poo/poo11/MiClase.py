...
class MiClase:
    ...
    def metodo_clase(cls):
        print(f"Accediendo a varibale de clase desde el metodo de clase: {cls.variable_clase}")
        print("metodo clase")

    # metodos de instancia. Se asocia con los objetos y no con la clase. Accede a las varibales de la instancia
    def metodo_instancia(self):
        print(f"Accediendo a varibale de instancia desde el metodo de instancia: {self.variable_instancia}")
...
MiClase.variable_clase2_nueva = "variable de clase nueva"  # type: ignore

print(MiClase.variable_clase)
print(MiClase.variable_clase2_nueva)  # type: ignore
print(miClase1.variable_clase)
print(miClase1.variable_clase2_nueva)  # type: ignore
miClase1.metodo_instancia()

miClase2 = MiClase("variable de instancia 2")
print(miClase2.variable_instancia)
print(miClase2.variable_clase)
print(miClase2.variable_clase2_nueva)  # type: ignore
